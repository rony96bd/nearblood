                ...
                <div class="col-lg-12">
                    <div class="donor-profile">
                        ...
                        <div class="donor-profile__content">
                            ...
                            <p><i class="las la-map-marker-alt mt-2"></i> @lang('Location') :
                                {{ __($donor->location->name) }}, {{ __($donor->city->name) }}</p>
                            <ul class="d-flex flex-wrap align-items-center donor-card__social justify-content-center mt-1">
                                <li><a href="{{ __(@$donor->socialMedia->facebook) }}" target="_blank" tabindex="-1"><i
                                            class="lab la-facebook-f"></i></a></li>
                                <li><a href="{{ __(@$donor->socialMedia->twitter) }}" target="_blank" tabindex="-1"><i
                                            class="lab la-twitter"></i></a></li>
                                <li><a href="{{ __(@$donor->socialMedia->linkedinIn) }}" target="_blank" tabindex="-1"><i
                                            class="lab la-linkedin-in"></i></a></li>
                                <li><a href="{{ __(@$donor->socialMedia->instagram) }}" tabindex="-1"><i
                        ...
                        <li>
                            ...
                            @if (auth()->guard('donor')->check())
                                ...
                                <span class="value">{{ __($donor->phone) }} <a
                                        ...
                                        WhatsApp</a></span>
                            @else
                                <span class="value">01xxxxxxxxx <a href="https://nearblood.com/apply/donor">  Click to signup
                                        or
                                        login</a></span>
                            @endif
                        </li>
                            ...
                            <form method="POST" action="{{ route('donor.contact') }}" class="contact-donor-form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" value="{{ old('name') }}"
                                        class="form--control form-control-md" placeholder="@lang('Enter name')"
                                        maxlength="80" required="">
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" value="{{ old('email') }}"
                                        class="form--control form-control-md" placeholder="@lang('Enter email')"
                                        maxlength="80" required="">
                                </div>
                                <div class="form-group">
