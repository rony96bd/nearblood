...
<section class="pt-100 pb-100">
                    ...
                    <div class="blog-post">
                        <div class="blog-post__thumb">
                            <a href="{{ route('blog.details', [$blogElement->id, slug($blogElement->data_values->title)]) }}"
                                class="d-block"><img
                                    src="{{ getImage('assets/images/frontend/blog/' . @$blogElement->data_values->blog_image, '728x465') }}"
                                    alt="@lang('image1')"></a>
                        </div>
    ...
    <div style="width: 100%; padding-top: 20px" class="text-center">
        <span>
            <a href="{{ route('blog') }}" class="custom-btn2"
                style="background: #FB3640; border-radius: 5px; padding: 4px 10px 3px 10px; color: white; font-weight: bold;">
                সকল পোস্ট
            </a>
        </span>
    </div>
